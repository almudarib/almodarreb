...
export default function SubAdminEditUserModal({
  open,
  user,
  onClose,
  onSaved,
  ...
  const isTeacher = form.kind === 'teacher';
  const isSubAdmin = form.kind === 'sub_admin';
      ...
      <Box sx={{ p: 2 }}>
        <Stack spacing={2}>
          ...
          <Select
            ...
            disabled={isSubAdmin}
          >
            {isTeacher && <MenuItem value="teacher">معلّم</MenuItem>}
            {isSubAdmin && <MenuItem value="sub_admin">أدمن فرعي</MenuItem>}
          </Select>
        </Stack>
      </Box>
    </Modal>
