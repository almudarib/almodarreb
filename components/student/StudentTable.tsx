          ...
          {bulkCtx ? (
            <Stack direction="row" spacing={1} alignItems="center">
              ...
              <DeleteWarning
                ...
                title={
                  bulkAction === 'del'
                    ? 'تأكيد التعطيل الجماعي'
                    : bulkAction === 'pass'
                    ? 'تأكيد تعيين الكل ناجح'
                    : bulkAction === 'fail'
                ...
                description={
                  bulkAction === 'del'
                    ? 'سيتم تعطيل جميع طلاب هذا المعلم وإيقاف الاختبارات لهم، دون حذف سجلات المحاسبة، باستثناء المستثنين.'
                    : bulkAction === 'pass'
                    ? 'سيتم تعيين حالة جميع طلاب هذا المعلم إلى "ناجح" باستثناء المستثنين.'
                    : bulkAction === 'fail'
                ...
                impacts={
                  bulkAction === 'del'
                    ? ['إيقاف عرض الاختبارات', 'الإبقاء على سجلات المحاسبة', 'يمكن إظهاره لاحقًا']
                    : bulkAction === 'pass'
                    ? ['تحديث حالة الطلاب إلى "ناجح"']
                    : bulkAction === 'fail'
